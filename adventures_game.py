...
if left_right == 'left':
    ...
    if swim_wait == "swim":
        ...
        print("After waiting for a bit, a boat drift the the coast before you use it and go to the island in the middle of the lake.")
        ...
        elif left_right_door == 'blue':
            print("You enter a room full of ice and freeze to death. Game Over")
        elif left_right_door == 'red':
            print("You enter a room full of fire and lava. Game Over")
